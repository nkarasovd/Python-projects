...
# Algorithm:
# 1. Break reads into k-mers and create de Bruijn graph
...
class PhiX174GenomeAssembler(BubbleRemoval):
    ...
    def assemble(self):
        ...
        circular_genome = self.kmer_ids.k_mers[cycle[0]]
        for i in range(1, len(cycle) - (self.k - 1)):
            circular_genome += self.kmer_ids.k_mers[cycle[i]][-1]
