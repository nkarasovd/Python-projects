...
class Solver:
    ...
    def ask(self, a, b, l):
        if self.get_hash_of(self.hash1, self.powers1, a, self.m1, l) == self.get_hash_of(self.hash1, self.powers1, b,
                                                                                         self.m1, l):
            if self.get_hash_of(self.hash2, self.powers2, a, self.m2, l) == self.get_hash_of(self.hash2, self.powers2,
                                                                                             b, self.m2, l):
